...
def logistic(a, x):
    ...
    ----------
    a : float
        The value of the coefficient in the logistic map.
    x : float
        The current point in the domain of the logistic map.

    Returns
    -------
    The value of the logistic map for specified a and x.
    """
    return round(a * x * (1 - x), 8)


def f_L(a, x):
    """
    The left branch of the logistic map.
    """
    c_0 = 0.5
    if 0 <= x <= c_0:
        return logistic(a, x)
...
def f_R(a, x):
    """
    The right branch of the logistic map.
    """
    c_0 = 0.5
    if c_0 <= x <= 1:
        return logistic(a, x)
...
def range_f_L(a, interval):
    """
    Finds the range of values for the left branch of the logistic map on a given interval.
    """
    c_0 = 0.5
...
def range_f_R(a, interval):
    """
    Finds the range of values for the right branch of the logistic map on a given interval.
    """
    c_0 = 0.5
